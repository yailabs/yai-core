...
info:
	...
	@printf "status: SPINE.38 Replay Diagnostics / Rebuild Report\n"
	@printf "completed: SPINE.20 Local Runtime Layout through SPINE.38 Replay Diagnostics / Rebuild Report\n"
	@printf "next: SPINE.39 Journal Replay Freeze\n"
