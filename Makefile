...
info:
	...
	@printf "status: SPINE.46 DuckDB Fact Plane Doctrine + Bitemporal Schema\n"
	@printf "completed: SPINE.20 Local Runtime Layout through SPINE.46 DuckDB Fact Plane Doctrine + Bitemporal Schema\n"
	@printf "next: SPINE.47 Receipt / Decision / Projection Facts\n"
	...
	@printf "fact-plane: DuckDB yai.fact.v1 bitemporal schema\n"
