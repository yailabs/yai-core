...
| Item | Value | Source |
| --- | --- | --- |
| Command | `labs/shared/bin/probe-local-provider.sh --host ${YAI_PROVIDER_HOST:-127.0.0.1} --port ${YAI_PROVIDER_PORT:-43117} --prompt-id local-provider-ready` | transcript.md |
...
| --- | --- | --- |
| pack-fixture | absent | No pack fixture directory is present for this lab. |
