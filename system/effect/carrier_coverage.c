...
static const yai_carrier_coverage_t coverage[] = {
    ...
    {YAI_CARRIER_FAMILY_NETWORK_HTTP, YAI_CARRIER_ADAPTER_SKELETON, YAI_CARRIER_ADAPTER_SKELETON, YAI_CARRIER_ADAPTER_SKELETON, "false", "none", 1, "carrier.v1", "executed,blocked,failed,mismatch", "visible skeleton; no network execution"},
    {YAI_CARRIER_FAMILY_DATABASE, YAI_CARRIER_ADAPTER_SKELETON, YAI_CARRIER_ADAPTER_SKELETON, YAI_CARRIER_ADAPTER_SKELETON, "false", "none", 1, "carrier.v1", "executed,blocked,failed,mismatch", "visible skeleton; no database execution"},
    {YAI_CARRIER_FAMILY_REPOSITORY_GIT, YAI_CARRIER_ADAPTER_SKELETON, YAI_CARRIER_ADAPTER_SKELETON, YAI_CARRIER_ADAPTER_SKELETON, "false", "none", 1, "carrier.v1", "executed,blocked,failed,mismatch", "visible skeleton; no git execution"},
    {YAI_CARRIER_FAMILY_SERVICE, YAI_CARRIER_ADAPTER_SKELETON, YAI_CARRIER_ADAPTER_SKELETON, YAI_CARRIER_ADAPTER_SKELETON, "false", "none", 1, "carrier.v1", "executed,blocked,failed,mismatch", "visible skeleton; no service lifecycle control"},
    {YAI_CARRIER_FAMILY_ENDPOINT, YAI_CARRIER_ADAPTER_SKELETON, YAI_CARRIER_ADAPTER_SKELETON, YAI_CARRIER_ADAPTER_SKELETON, "false", "none", 1, "carrier.v1", "executed,blocked,failed,mismatch", "visible skeleton; no endpoint execution"},
    {YAI_CARRIER_FAMILY_SOCKET, YAI_CARRIER_ADAPTER_SKELETON, YAI_CARRIER_ADAPTER_SKELETON, YAI_CARRIER_ADAPTER_SKELETON, "false", "none", 1, "carrier.v1", "executed,blocked,failed,mismatch", "visible skeleton; no socket control"},
    {YAI_CARRIER_FAMILY_LISTENER, YAI_CARRIER_ADAPTER_SKELETON, YAI_CARRIER_ADAPTER_SKELETON, YAI_CARRIER_ADAPTER_SKELETON, "false", "none", 1, "carrier.v1", "executed,blocked,failed,mismatch", "visible skeleton; no listener control"},
    {YAI_CARRIER_FAMILY_MODEL_PROVIDER, YAI_CARRIER_ADAPTER_PLANNED, YAI_CARRIER_ADAPTER_PLANNED, YAI_CARRIER_ADAPTER_SKELETON, "false", "none", 1, "carrier.v1", "observed,failed,mismatch,not_attempted", "visible skeleton; no model provider carrier execution"},
    ...
    {YAI_CARRIER_FAMILY_REVIEW, YAI_CARRIER_ADAPTER_UNSUPPORTED, YAI_CARRIER_ADAPTER_UNSUPPORTED, YAI_CARRIER_ADAPTER_SKELETON, "false", "review_lane_only", 1, "carrier.v1", "deferred,waiting_operator,waiting_agent,not_attempted", "review is not machine effect execution"},
