...
static const yai_carrier_skeleton_t skeletons[] = {
    ...
    {YAI_CARRIER_FAMILY_MODEL_PROVIDER, "model_provider", "carrier.v1", YAI_CARRIER_ADAPTER_SKELETON, YAI_CARRIER_ADAPTER_PLANNED, YAI_CARRIER_ADAPTER_PLANNED, YAI_CARRIER_ADAPTER_SKELETON, 0, 1, 1, "model_provider_carrier_not_implemented", "SPINE.93A+"},
