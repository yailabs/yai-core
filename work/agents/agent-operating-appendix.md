...
```text
1. Read work/spines/current-status.md.
2. Read work/spines/yai-spine.md.
3. Read work/spines/command-surface.md.
4. Read work/spines/source-surface.md.
5. Check git status.
6. Identify whether the touched concept exists in yai-dev.
7. Update work/inventories/extraction-inventory.tsv if old residue is touched.
