...
Source ownership details live in `work/spines/source-surface.md`.

Pack format doctrine lives under `work/archive/engineering-snapshots/pack-format.md`. SPINE.21
...
Historical references are archived under `work/archive/legacy-docs/engineering/`.
...
socket and hot-state snapshot lives in `work/spines/command-surface.md`.
