...
and data-plane implementation. SPINE.21 defines packs as case materialization
units.
...
labels inside one linear SPINE.N roadmap. `work/spines/yai-spine.md`
...
`work/spines/yai-spine.md` the only active roadmap, archives wave
