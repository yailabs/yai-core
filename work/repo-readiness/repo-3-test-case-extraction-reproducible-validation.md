...
- `work/repo-readiness/repo-3-test-case-extraction-reproducible-validation.md`
...
```text
required control/carrier file missing: work/archive/architecture-snapshots/18-control-carrier-substrate.md
