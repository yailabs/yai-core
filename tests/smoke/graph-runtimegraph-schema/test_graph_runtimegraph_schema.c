...
int main(void) {
    static const node_case_t nodes[] = {
        ...
        {YAI_GRAPH_NODE_REVIEW_REQUEST, "review_request"},
        {YAI_GRAPH_NODE_REVIEW_DECISION, "review_decision"},
        {YAI_GRAPH_NODE_CONTROL_PENDING, "control_pending"},
    ...
    static const edge_case_t edges[] = {
        ...
        {YAI_GRAPH_SCHEMA_EDGE_REVIEW_REQUEST_FOR_ATTEMPT, "review_request_for_attempt"},
        {YAI_GRAPH_SCHEMA_EDGE_REVIEW_DECISION_RESOLVES_REQUEST, "review_decision_resolves_request"},
        {YAI_GRAPH_SCHEMA_EDGE_CONTROL_PENDING_BLOCKS_ATTEMPT, "control_pending_blocks_attempt"},
        {YAI_GRAPH_SCHEMA_EDGE_REVIEW_RESOLUTION_PRODUCES_RECEIPT, "review_resolution_produces_receipt"},
