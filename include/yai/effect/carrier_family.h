...
typedef enum yai_carrier_family {
    ...
    YAI_CARRIER_FAMILY_SERVICE = 5,
    YAI_CARRIER_FAMILY_ENDPOINT = 6,
    YAI_CARRIER_FAMILY_SOCKET = 7,
    YAI_CARRIER_FAMILY_LISTENER = 8,
    YAI_CARRIER_FAMILY_MODEL_PROVIDER = 9,
    YAI_CARRIER_FAMILY_OBSERVATION = 10,
    YAI_CARRIER_FAMILY_REVIEW = 11,
    YAI_CARRIER_FAMILY_UNKNOWN = 12
