...
Status: SPINE.5 VIEW spine doctrine, based on SPINE.3R.
...
SPINE.5 tracks projection under the `VIEW` macro-spine. Future projection waves
must declare projection frame schema, delta schema, freshness/staleness rules,
redaction posture, authority alignment, memory patch integration, divergence
exposure, consumer templates, invalidation tests and Case View Quality metrics.
