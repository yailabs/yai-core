...
|---|---|---|---|
| `yai` | Canonical local AI operational control system. | Completed foundation through SPINE.32 LMDB subject/receipt indexes. | SPINE.33 LMDB CLI + Manual Validation. |
