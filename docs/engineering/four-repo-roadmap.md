...
|---|---|---|---|
| `yai` | Canonical local AI operational control system. | Completed foundation through SPINE.33F carrier coverage matrix. | SPINE.33G Non-Process Carrier Skeletons. |
