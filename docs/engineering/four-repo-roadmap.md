...
|---|---|---|---|
| `yai` | Canonical local AI operational control system. | Completed foundation through SPINE.33E host observation probe. | SPINE.33F Carrier Receipt / Divergence Hardening. |
